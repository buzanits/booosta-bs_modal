# Bootstrap based modal window for PHP Booosta webapps

This modules provides a bootstrap bases modal window. It can be opened by the user with a click on a
link. Then it displays the configured content.
